...
type QuizSectionHeaderProps = {
  /** Number of quizzes available in the section. */
  quizCount: number;
 ...
 *
 * The heading, quiz count, and supporting description remain centered to match
 * the visual alignment used throughout GeoPedia's quiz overview pages.
 *
 * @param props - Quiz section header properties.
 * @param props.quizCount - Number of quizzes available in the section.
