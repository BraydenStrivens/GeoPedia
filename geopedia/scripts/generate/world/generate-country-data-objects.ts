...
const SOURCE_COUNTRIES_PATH = "data/source/countries.json";

const COUNTRY_IMAGES_DIRECTORY = "public/data/country-images";

const COUNTRY_FLAGS_DIRECTORY = "public/data/country-flags";
