"""
Simplify Senegal administrative GeoJSON for GeoPedia runtime use.
...
Output
------
public/data/countries/senegal/geojson/
...
Simplification is performed directly in the source geographic CRS, so the
configured tolerances are specified in degrees.
...
LEVELS = {
    ...
    "departments": {
        "tolerance": 0.002,
        "expected_count": 46,
        "id_property": "department_id",
    },
    "arrondissements": {
        "tolerance": 0.001,
        "expected_count": 125,
        "id_property": "arrondissement_id",
    },
}
...
def main() -> None:
    """Simplify all Senegal administrative levels."""
    OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

    print("Simplifying Senegal administrative GeoJSON...")
    ...
    print()
    print("Senegal administrative simplification complete.")
